	...
	<div class="col-md-12">
		<div class="portlet box green-hulk">
			<div class="portlet-title">
				...
				<div class="actions">
					<a href="<?php echo base_url(); ?>admin/reservation/listing" class="btn btn-default btn-sm">
						Reservation List
					</a>
				</div>
			</div>
...
<div class="modal fade modal-booking modal-overflow" tabindex="-1" data-width="900" data-backdrop="static" data-keyboard="false">
	...
	<div class="modal-body form">
		<form action="<?php echo base_url(); ?>admin/reservation/confirm" class="form-horizontal form-confirm-booking" method="POST">
			...
			<div class="form-body">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							<label class="control-label col-md-3 bold">Customer Name:</label>
							<div class="col-md-9">
								<input type="text" name="customer_name" class="form-control customer_name" value="" autocomplete="off" />
							</div>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							<label class="control-label col-md-3 bold"> Contact No:</label>
							<div class="col-md-9">
								<input type="text" name="contact_no" class="form-control contact_no" value="" autocomplete="off" />
							</div>
						</div>
					</div>
				</div>
	...
	<div class="modal-footer">
		...
		<button type="button" class="btn btn-sm dark btn-confirm-booking"> Confirm Reservation </button>
	</div>
</div>
...
<script type="text/javascript">
	var checkAvailability = function(){
		$.ajax({
			url: baseUrl + 'admin/reservation/check_availability',
			method: "POST",
	...
	var checkLogin = function(){
		...
		$.ajax({
			url: baseUrl + 'admin/user/check_login',
			method: "POST",
			dataType: 'json',
			// async: false,
			success: function(result){
				if(result['result'] == "failed"){
					location.href = baseUrl + 'admin/login/logout';
				}
				else{
					checkAvailability();
				}
			...
			$('.form-confirm-booking').ajaxSubmit({
				...
				success: function(result){
					if(result['result'] == "failed"){
						...
						location.href = baseUrl + 'admin/reservation/listing';
					}
				}
			});
		});
