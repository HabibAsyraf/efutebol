														...
														<form action="" method="POST" class="form-register">
															<div class="form-body">
																<div class="row">
																	<div class="col-md-offset-3 col-md-6">
																		<div class="form-group">
																			...
																			<input autocomplete="off" type="text" class="form-control input-sm name" name="name" value="">
																...
																<div class="row">
																	<div class="col-md-offset-3 col-md-6">
																		<br/>
																		Already have a eFutebol account? <a href="#">Log In Now</a>
																	</div>
																</div>
															</div>
															<div class="form-actions fluid">
																<div class="row">
																	<div class="col-md-offset-3 col-md-9">
																		<button type="button" class="btn green-hulk">Submit</button>
